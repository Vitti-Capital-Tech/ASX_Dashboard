...
def generate_client_email(summary_text: str) -> str:
    prompt = f"""
You are an investment analyst. Based on the following information extracted from an equity placement or offer document, draft a professional client email summarizing the key investment opportunity.

If there is not enough information, simply return the text "not enough information".

IMPORTANT FORMATTING RULES:
- Output ONLY pure HTML content (no markdown, no code blocks, no ```html markers)
- Start with an <h1> tag containing a compelling subject line for the email (this will be extracted as the email subject)
- After the h1, start directly with HTML tags like <h2> or <p>
- Use proper HTML tables with full borders for any tabular data
- Keep language simple and professional
- No fancy symbols, special quotes, or em-dashes

STRUCTURE:
1. Start with: <h1>Specific Company Name - Brief Opportunity Description</h1>
2. Then <h2>Company Overview</h2>
3. Provide 1-2 paragraphs about the company
4. Include key details if present:
   - Company name and ticker
   - Issue/offer price
   - Key highlights and use of funds
   - Bidding dates
5. DO NOT mention minimum investment amounts
6. DO NOT mention brokerage fees
7. Use headings (<h2>, <h3>), lists (<ul>, <li>), and tables where appropriate
8. End with: <p>For more information, please contact us.</p>

Write in a manner that even a novice finds easy to understand and interesting to read.
No greetings, signatures, email addresses, or contact numbers needed.

IMPORTANT! DO NOT include broker fees in the email.

Information:
{summary_text}

Remember: Output ONLY the HTML body content starting with <h1>, no markdown formatting.
""".strip()
